...
@Component({
  selector: 'app-kesalahan',
  template: `
  <div class="container">
      <div class="row mt-4">
          <div class="col-12">
              <div class="widget widget-bg CormorantGaramond mobile-hide">
                  <h3 class="widget-header">
                      Whoaa~ Halaman yang kamu cari tidak ada .. >_<"
                  </h3>
                  <div class="widget-content">
                      <svg class="me404" width="100%" viewBox="0 0 1000 480">
  ...
  `,
  styleUrls: ['./kesalahan.component.css']
})
export class KesalahanComponent implements OnInit {
